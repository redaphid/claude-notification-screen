...
Author:
 ...
 SPD2010 QSPI panel support (Waveshare ESP32-S3-Touch-LCD-1.46, 412x412 round).
...
//----------------------------------------------------------------------------
  ...
  struct Panel_SPD2010 : public Panel_Device
  {
  public:
    Panel_SPD2010(void)
    {
      _cfg.panel_width  = _cfg.memory_width  = 412;
      _cfg.panel_height = _cfg.memory_height = 412;
